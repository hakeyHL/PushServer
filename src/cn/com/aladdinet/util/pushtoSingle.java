...
public class pushtoSingle {
	static String appId = "9RoCOLsGeb7pTYHhtxnOX1";
	static String appkey = "rneYU2x0mK6tpxu5I26369";
	static String master = "RBivfFilYd7PcmgwiH9cV8";
	static String CID = "eed23e449b17b45b3e6179ef36a9066a";
	static String Alias = "huli";
	...
	public static void main(String[] args) throws Exception {
		...
		template.setLogoUrl("http://www.getui.com/wp-content/uploads/2.3.0/logo.png");
		template.setTitle("云企通推送测试");
		template.setText("春节大酬宾!!!");
	...
	public static TransmissionTemplate TransmissionTemplateDemo() throws Exception {
		...
		// new com.gexin.rp.sdk.base.payload.APNPayload.SimpleAlertMsg(
		// "hahahaha");
